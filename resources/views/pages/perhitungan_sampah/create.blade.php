        ...
        <div id="horizontal-alignment-1" role="tabpanel" aria-labelledby="horizontal-alignment-item-1">
            <form action="{{route('perhitungan_sampah.store')}}" method="post" class="grid grid-cols-2 gap-6 mt-2">
              ...
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <x-label for="subkategori_id_subkategori">{{ __('Subkategori') }} </x-label>
                <select id="subkategori_id_subkategori" name="subkategori_id_subkategori" :value="old('subkategori_id_subkategori')" required class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    <option value="" disabled selected>Select an option</option>
